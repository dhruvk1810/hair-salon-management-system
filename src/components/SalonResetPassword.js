...
class SalonResetPassword extends Component {
    constructor(props) {
        super(props);
        this.state = {
            password: '',
    ...
    handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`http://localhost:5000/api/salons/reset-password`, {
                method: 'POST',
...
export default withLocation(SalonResetPassword);
